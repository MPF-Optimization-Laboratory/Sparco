...
% 25 Jul 09: Updated to use Spot operators.
%
%   Copyright 2008, Ewout van den Berg and Michael P. Friedlander
%   http://www.cs.ubc.ca/labs/scl/sparco
%   $Id: prob501.m 1517 2009-09-26 02:57:28Z ewout78 $
...
Mh(1,1) = 1;
r       = find(Mh);  % Restriction

% Create operators
F = opDFT2(n,n);
H = opHaar2(n,n);    
B = H';              % Sparsity basis
M = F(r,:);          % Measurement operator
